...
class Act12_AddView : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_act12_add_view)
        ...
        val inflater = LayoutInflater.from(this@Act12_AddView)



        for(i in 0 until carList.size) {
            val itemView = inflater.inflate(R.layout.act12_item_view, null)
